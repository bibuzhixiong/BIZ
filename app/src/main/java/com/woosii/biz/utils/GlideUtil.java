...
//                    .placeholder(R.drawable.icon_glide_loading).error(R.drawable.icon_glide_failed)
...
//                .placeholder(R.drawable.icon_glide_loading).error(R.drawable.icon_glide_failed)
    ...
    public void LoadSupportv4FragmentCircleBitmap(android.support.v4.app.Fragment fragment, String path, ImageView imageView) {
        LoadSupportv4FragmentCircleBitmap(fragment, path, imageView, 0, 0);
    }
    ...
    /*public void LoadContextRoundBitmapCircle(Context context, String path, ImageView imageView, int roundradius) {
        //带白色边框的圆形图片加载
        Glide.with(context).load(path).centerCrop().placeholder(R.drawable.def_touxiang)
                .transform(new GlideCircleTransform1(context, 2, context.getResources().getColor(R.color.white)))
